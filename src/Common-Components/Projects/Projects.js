    ...
    render() {
        return (
            <Cards>
                ...
                <Cards.Column style = {{marginBottom:"70px"},{margin: "0px -633px 52px 387px"}}><button style = {{color:"white",borderRadius:"30px",border:"none",padding: "10px 20px"}} onClick={this.handleClick}>ALL</button></Cards.Column>
